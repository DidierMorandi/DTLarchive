"""Internationalisation helpers for DTLarchive."""
...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "app.subtitle": {"fr": "Explorateur local des archives ChatGPT", "en": "Local ChatGPT archive explorer"},
    ...
    "file.press_key_language": {"fr": "Appuyez sur Entrée pour continuer, ou saisissez 1 pour passer en anglais, ou ? pour obtenir de l'aide...", "en": "Press Enter to continue, or enter 2 to switch to French, or ? for help..."},
